...
{
    public class ServiceRemotingRequestJsonMessageBodySerializerTests
    {
        private readonly ServiceRemotingRequestJsonMessageBodySerializer _serializer = new ServiceRemotingRequestJsonMessageBodySerializer();
